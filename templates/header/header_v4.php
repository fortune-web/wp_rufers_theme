...
$logo_typography = '';
?>
    <?php if( $options->get('show_sidebar_info_v4') ){ ?>   
                ...
                <div class="sidebar-textwidget">
                    <div class="sidebar-info-contents">
                        <div class="content-inner">
							...
							<?php if( $options->get('sidebar_title_v4') || $options->get('sidebar_text_v4')){ ?>
                            <div class="content-box">
                                <h4><?php echo wp_kses($options->get('sidebar_title_v4'), true);?></h4>
                                <div class="inner-text">
                                    <p><?php echo wp_kses($options->get('sidebar_text_v4'), true);?></p>
                                </div>
                            </div>
							<?php } ?>
                            
                            <div class="form-inner">
                                <h4><?php echo wp_kses($options->get('form_title_v4'), true);?></h4>
                                <?php echo do_shortcode($options->get('form_url_v4'));?>
                            </div>

                            <div class="sidebar-contact-info">
                                <?php if($options->get('sidebar_sub_title_v4')){ ?>
                                <h4><?php echo wp_kses($options->get('sidebar_sub_title_v4'), true);?></h4>
								<?php } ?>
                                <ul>
                                    <?php if($options->get('sidebar_address_v4')){ ?>
                                    <li>
                                        <span class="flaticon-pin-1"></span> <?php echo wp_kses($options->get('sidebar_address_v4'), true);?>
                                    </li>
                                    <?php } ?>
                                    <?php if($options->get('sidebar_phone_no_v4')){ ?>
                                    <li>
                                        <span class="flaticon-telephone"></span>
                                        <a href="tel:<?php echo esc_attr($options->get('sidebar_phone_no_v4'));?>"><?php echo wp_kses($options->get('sidebar_phone_no_v4'), true);?></a>
                                    </li>
                                    <?php } ?>
                                    <?php if($options->get('sidebar_email_address_v4')){ ?>
                                    <li>
                                        <span class="flaticon-mail"></span>
                                        <a href="mailto:<?php echo esc_attr($options->get('sidebar_email_address_v4'));?>"><?php echo wp_kses($options->get('sidebar_email_address_v4'), true);?></a>
                                    </li>
                                    <?php } ?>
                                </ul>
                            </div>
                            <?php
								$icons = $options->get( 'sidebar_social_share_v4' );
								if ( ! empty( $icons ) ) :
							?>
                        ...
                        <div class="outer-box">
                            ...
                            <div class="header-top__left">
                                <div class="welcome-text">
                                    <p><?php echo wp_kses($options->get('welcome_text_v4'), true);?></p>
                                </div>
                            </div>
							<?php } ?>
                            <div class="header-top__right">
                                <?php if($options->get('phone_no_v4') || $options->get('email_v4')){ ?>
                                <div class="header-contact-info text-right-rtl">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <div class="text">
                                                <h6><a href="tel:<?php echo esc_attr($options->get('phone_no_v4'));?>"><?php echo wp_kses($options->get('phone_no_v4'), true);?></a></h6>
                                            </div>
                                        </li>
                                        <?php } ?>
                                        <?php if($options->get('email_v4')){ ?>
                                        <li>
                                            <div class="icon">
                                                <span class="flaticon-email-1"></span>
                                            </div>
                                            <div class="text">
                                                <h6><a href="mailto:<?php echo esc_attr($options->get('email_v4'));?>"><?php echo wp_kses($options->get('email_v4'), true);?></a></h6>
                                            </div>
                                        </li>
                                        <?php } ?>
                                    </ul>
                    ...
                    <div class="auto-container">
                        <div class="outer-box">
                            ...
                            <div class="header-right">
                                <?php if( $options->get('show_shoping_cart_icon_v4') ){ ?>
                                ...
                                <?php if( $options->get('show_search_form_v4') ){ ?>
                                ...
                                <?php if( $options->get('btn_link_v4') || $options->get('btn_title_v4')){ ?>
                                <div class="header-right_buttom">
                                    <div class="btns-box">
                                        <a class="btn-one" href="<?php echo esc_url($options->get('btn_link_v4'));?>">
                                            <i class="fa fa-angle-right" aria-hidden="true"></i>
                                            <span class="txt"><?php echo wp_kses($options->get('btn_title_v4'), true);?></span>
                                        </a>
                                    </div>
                                </div>
                                <?php } ?>
