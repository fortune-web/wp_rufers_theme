 ...
 */
//rufers_load_default_hooks
function rufers_load_default_hooks() {

	$config = rufers_WSH()->config( 'default' );
...
/**
 * [rufers_main_header_area description]
 *
 * @return [type] [description]
 */

//rufers_main_header_area
function rufers_main_header_area() {
	...
	//need to change
	if ( $header == 'header_v1' ) {
		rufers_template_load( 'templates/header/default-header.php' );
	} elseif ( $header == 'header_v2' ) {
		rufers_template_load( 'templates/header/header_v2.php' );
	} elseif ( $header == 'header_v3' ) {
		rufers_template_load( 'templates/header/header_v3.php' );
	} elseif ( $header == 'header_v4' ) {
		rufers_template_load( 'templates/header/header_v4.php' );
	} else {
		rufers_template_load( 'templates/header/default-header.php' );
	}
}
...
/**
 * [rufers_main_footer_area description]
 *
 * @return [type] [description]
 */
//rufers_main_footer_area
function rufers_main_footer_area() {
	...
	//need to change
	if ( $footer == 'footer_v1' ) {
		rufers_template_load( 'templates/footer/default-footer.php' );
	} elseif ( $footer == 'footer_v2' ) {
		rufers_template_load( 'templates/footer/footer_v2.php' );
	} elseif ( $footer == 'footer_v3' ) {
		rufers_template_load( 'templates/footer/footer_v3.php' );
	} else {
		rufers_template_load( 'templates/footer/default-footer.php' );
	}
}
...
/**
 * [rufers_sidebar description]
 *
 * @return [type] [description]
 */
//rufers_sidebar
function rufers_sidebar( $data ) {

	rufers_template_load( 'templates/sidebar.php', compact( 'data' ) );
}

/**
 * [rufers_banner description]
 *
 * @return [type] [description]
 */
//rufers_banner
function rufers_banner( $data ) {

	rufers_template_load( 'templates/banner/banner.php', compact( 'data' ) );
