...
class Options {
	 ...
	 * @var string
	 */
	private $opt_name = 'rufers' . '_options';
	...
	private $page_slug = 'rufers' . '_options';
	...
	function init() {
		...
		$this->menu_title = esc_html__( 'RUFERS Options', 'rufers' );
		$this->page_title = esc_html__( 'RUFERS Options', 'rufers' );
	...
	function args() {
		...
		$args = array(
			...
			'global_variable'      => 'rufers_options',
	...
	function helpTabs() {
		...
		$tabs = array(
			array(
				'id'      => 'redux-help-tab-1',
				'title'   => esc_html__( 'Theme Information 1', 'rufers' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'rufers' ),
			),
			array(
				'id'      => 'redux-help-tab-2',
				'title'   => esc_html__( 'Theme Information 2', 'rufers' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'rufers' ),
			),
		);
		...
		$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'rufers' ) . '</p>';
	...
	function sections() {
		...
		$sections_path = apply_filters( 'rufers_redux_sections', $sections_path );
		...
		foreach ( $sections_path as $key => $file ) {
			...
			if ( file_exists( $file ) ) {
				...
				$options = apply_filters( "rufers_redux_sections_{$key}", $options );
