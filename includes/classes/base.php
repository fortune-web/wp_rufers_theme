...
use RUFERS\Includes\Classes\Header_Enqueue;
use RUFERS\Includes\Classes\Options;
...
class Base {
	...
	public static function instance() {
		...
		if ( isset( $GLOBALS['rufers_base'] ) ) {
			return $GLOBALS['rufers_base'];
		}
	...
	function option( $key = '' ) {
		...
		$options = (array) get_theme_mod( 'rufers' . '_options-mods' );

		$dn = rufers_dot( $options );
