...
get_header();
global $wp_query;
$data  = \RUFERS\Includes\Classes\Common::instance()->data( 'search' )->get();
            ...
            <div class="row text-right-rtl">
                ...
                <div class="content-side <?php echo esc_attr( $class ); ?>">
                    ...
                    <div class="search-notfound">
                        <p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'rufers' ); ?></p>
